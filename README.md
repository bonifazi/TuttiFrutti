...
* [Compute general validation statistics](https://github.com/bonifazi/TuttiFrutti/blob/main/Validation_stats.R). Function to compute general validation statistics from NextGP software (to be documented).
...
* function to extract usr/bin/time -v loginfo
* function to extract hpblup log info
* function to extract mixblup datafile sizes
